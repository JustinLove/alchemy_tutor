...
table.insert( g_pixel_scene_01, {
		prob   			= at_lab_chance,
		material_file 	= "mods/alchemy_tutor/files/snowcave_lab_v.png",
...
table.insert( g_pixel_scene_01_alt, {
		prob   			= at_lab_chance,
		material_file 	= "mods/alchemy_tutor/files/snowcave_lab_v_alt.png",
		visual_file		= "",--"mods/alchemy_tutor/files/coalmine_lab_visual.png",
		background_file	= "",
		is_unique		= 0
	})
...
table.insert( g_pixel_scene_02, {
		prob   			= at_lab_chance,
		material_file 	= "mods/alchemy_tutor/files/snowcave_lab_h.png",
		visual_file		= "",--"mods/alchemy_tutor/files/coalmine_lab_visual.png",
		background_file	= "",
		is_unique		= 0
	})
